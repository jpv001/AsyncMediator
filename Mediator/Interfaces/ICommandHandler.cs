...
namespace AsyncMediator
{
    ...
    public interface ICommandHandler<in TCommand> where TCommand : ICommand
    {
        ...
        /// <returns>A <see cref="CommandWorkflowResult"/> that contains <see cref="System.ComponentModel.DataAnnotations.ValidationResult"/> messages and a Success flag</returns>
