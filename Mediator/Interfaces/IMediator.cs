...
namespace AsyncMediator
{
    ...
    /// and finding the right <see cref="IEventHandler{TEvent}"/>, <see cref="IQuery{TCriteria, TResult}"/>, <see cref="ILookupQuery{TResult}"/> or <see cref="ICommandHandler{TCommand}"/>
